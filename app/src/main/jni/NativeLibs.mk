...
ifeq ($(LIBWEBSOCKETS_TGZ_SOURCE),)
LIBWEBSOCKETS_TGZ_SOURCE := libwebsockets.tar.gz
endif
ifeq ($(MINIUPNPC_TGZ_SOURCE),)
MINIUPNPC_TGZ_SOURCE := miniupnpc-$(MINIUPNPC_VERSION).tar.gz
endif
...
MINIUPNPC_DIR := $(basename $(basename $(MINIUPNPC_TGZ_SOURCE)))
...
MINIUPNPC_TGZ_URL := http://miniupnp.free.fr/files/download.php?file=$(MINIUPNPC_TGZ_SOURCE)
...
.PHONY: \
 ...
 miniupnpc-x86_64 \
 miniupnpc-armeabi \
 miniupnpc-armeabi-v7a \
 miniupnpc-armeabi-v7a-hard \
 miniupnpc-arm64-v8a \
 miniupnpc-mips \
 miniupnpc-mips64 \
 openssl \
...
$(TARGET_X86): common zlib-x86 openssl-x86 libwebsockets-x86 miniupnpc-x86
$(TARGET_X86_64): common zlib-x86_64 openssl-x86_64 libwebsockets-x86_64 miniupnpc-x86_64
$(TARGET_ARM): common zlib-armeabi openssl-armeabi libwebsockets-armeabi miniupnpc-armeabi
$(TARGET_ARM_V7A): common zlib-armeabi-v7a openssl-armeabi-v7a libgstreamer-1.0-armeabi-v7a libwebsockets-armeabi-v7a miniupnpc-armeabi-v7a
$(TARGET_ARM_V7A_HARD): common zlib-armeabi-v7a-hard openssl-armeabi-v7a-hard libwebsockets-armeabi-v7a-hard miniupnpc-armeabi-v7a-hard
$(TARGET_ARM64_V8A): common zlib-arm64-v8a openssl-arm64-v8a libwebsockets-arm64-v8a miniupnpc-v8a
$(TARGET_MIPS): common zlib-mips openssl-mips libwebsockets-mips miniupnpc-mips
$(TARGET_MIPS64): common zlib-mips64 openssl-mips64 libwebsockets-mips64 miniupnpc-mips64
...
sources: $(ZLIB_TGZ_SOURCE) $(OPENSSL_TGZ_SOURCE) $(LIBWEBSOCKETS_TGZ_SOURCE) $(MINIUPNPC_TGZ_SOURCE)
...
$(MINIUPNPC_TGZ_SOURCE):
	$(WGET) -q -O $(MINIUPNPC_TGZ_SOURCE) $(MINIUPNPC_TGZ_URL)
...
miniupnpc-x86: $(TARGET_X86)/lib/libminiupnpc.a
miniupnpc-x86_64: $(TARGET_X86_64)/lib/libminiupnpc.a
miniupnpc-armeabi: $(TARGET_ARM)/lib/libminiupnpc.a
miniupnpc-armeabi-v7a: $(TARGET_ARM_V7A)/lib/libminiupnpc.a
miniupnpc-armeabi-v7a-hard: $(TARGET_ARM_V7A_HARD)/lib/libminiupnpc.a
miniupnpc-arm64-v8a: $(TARGET_ARM64_V8A)/lib/libminiupnpc.a
miniupnpc-mips: $(TARGET_MIPS)/lib/libminiupnpc.a
miniupnpc-mips64: $(TARGET_MIPS64)/lib/libminiupnpc.a

# Extracting/configuring sources

$(TARGET_X86)/src/$(MINIUPNPC_DIR): $(MINIUPNPC_TGZ_SOURCE) $(TOOLCHAIN_X86)
	-$(MKDIR) -p $(TARGET_X86)/src
	$(TAR) xf $(MINIUPNPC_TGZ_SOURCE) -C $(TARGET_X86)/src
	$(CD) $(TARGET_X86)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_X86_ENV) \
	  make

$(TARGET_X86_64)/src/$(MINIUPNPC_DIR): $(MINIUPNPC_TGZ_SOURCE) $(TOOLCHAIN_X86_64)
	-$(MKDIR) -p $(TARGET_X86_64)/src
	$(TAR) xf $(MINIUPNPC_TGZ_SOURCE) -C $(TARGET_X86_64)/src
	$(CD) $(TARGET_X86_64)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_X86_64_ENV) \
	  make

$(TARGET_ARM)/src/$(MINIUPNPC_DIR): $(MINIUPNPC_TGZ_SOURCE) $(TOOLCHAIN_ARM)
	-$(MKDIR) -p $(TARGET_ARM)/src
	$(TAR) xf $(MINIUPNPC_TGZ_SOURCE) -C $(TARGET_ARM)/src
	$(CD) $(TARGET_ARM)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_ARM_ENV) \
	  make

$(TARGET_ARM_V7A)/src/$(MINIUPNPC_DIR): $(MINIUPNPC_TGZ_SOURCE) $(TOOLCHAIN_ARM_V7A)
	-$(MKDIR) -p $(TARGET_ARM_V7A)/src
	$(TAR) xf $(MINIUPNPC_TGZ_SOURCE) -C $(TARGET_ARM_V7A)/src
	$(CD) $(TARGET_ARM_V7A)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_ARM_V7A_ENV) \
	  make

$(TARGET_ARM_V7A_HARD)/src/$(MINIUPNPC_DIR): $(MINIUPNPC_TGZ_SOURCE) $(TOOLCHAIN_ARM_V7A_HARD)
	-$(MKDIR) -p $(TARGET_ARM_V7A_HARD)/src
	$(TAR) xf $(MINIUPNPC_TGZ_SOURCE) -C $(TARGET_ARM_V7A_HARD)/src
	$(CD) $(TARGET_ARM_V7A_HARD)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_ARM_V7A_HARD_ENV) \
	  make

$(TARGET_ARM64_V8A)/src/$(MINIUPNPC_DIR): $(MINIUPNPC_TGZ_SOURCE) $(TOOLCHAIN_ARM64_V8A)
	-$(MKDIR) -p $(TARGET_ARM64_V8A)/src
	$(TAR) xf $(MINIUPNPC_TGZ_SOURCE) -C $(TARGET_ARM64_V8A)/src
	$(CD) $(TARGET_ARM64_V8A)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_ARM64_V8A_ENV) \
	  make

$(TARGET_MIPS)/src/$(MINIUPNPC_DIR): $(MINIUPNPC_TGZ_SOURCE) $(TOOLCHAIN_MIPS)
	-$(MKDIR) -p $(TARGET_MIPS)/src
	$(TAR) xf $(MINIUPNPC_TGZ_SOURCE) -C $(TARGET_MIPS)/src
	$(CD) $(TARGET_MIPS)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_MIPS_ENV) \
	  make

$(TARGET_MIPS64)/src/$(MINIUPNPC_DIR): $(MINIUPNPC_TGZ_SOURCE) $(TOOLCHAIN_MIPS64)
	-$(MKDIR) -p $(TARGET_MIPS64)/src
	$(TAR) xf $(MINIUPNPC_TGZ_SOURCE) -C $(TARGET_MIPS64)/src
	$(CD) $(TARGET_MIPS64)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_MIPS64_ENV) \
	  make

# Build/install library

$(TARGET_X86)/lib/libminiupnpc.a: $(TARGET_X86)/src/$(MINIUPNPC_DIR)
	$(CD) $(TARGET_X86)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_X86_ENV) INSTALLPREFIX=$(shell pwd)/$(TARGET_X86) $(MAKE) install

$(TARGET_X86_64)/lib/libminiupnpc.a: $(TARGET_X86_64)/src/$(MINIUPNPC_DIR)
	$(CD) $(TARGET_X86_64)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_X86_64_ENV) INSTALLPREFIX=$(shell pwd)/$(TARGET_X86_64) $(MAKE) install

$(TARGET_ARM)/lib/libminiupnpc.a: $(TARGET_ARM)/src/$(MINIUPNPC_DIR)
	$(CD) $(TARGET_ARM)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_ARM_ENV) INSTALLPREFIX=$(shell pwd)/$(TARGET_ARM) $(MAKE) install

$(TARGET_ARM_V7A)/lib/libminiupnpc.a: $(TARGET_ARM_V7A)/src/$(MINIUPNPC_DIR)
	$(CD) $(TARGET_ARM_V7A)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_ARM_V7A_ENV) INSTALLPREFIX=$(shell pwd)/$(TARGET_ARM_V7A) $(MAKE) install

$(TARGET_ARM_V7A_HARD)/lib/libminiupnpc.a: $(TARGET_ARM_V7A_HARD)/src/$(MINIUPNPC_DIR)
	$(CD) $(TARGET_ARM_V7A_HARD)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_ARM_V7A_HARD_ENV) INSTALLPREFIX=$(shell pwd)/$(TARGET_ARM_V7A_HARD) $(MAKE) install

$(TARGET_ARM64_V8A)/lib/libminiupnpc.a: $(TARGET_ARM64_V8A)/src/$(MINIUPNPC_DIR)
	$(CD) $(TARGET_ARM64_V8A)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_ARM64_V8A_ENV) INSTALLPREFIX=$(shell pwd)/$(TARGET_ARM64_V8A) $(MAKE) install

$(TARGET_MIPS)/lib/libminiupnpc.a: $(TARGET_MIPS)/src/$(MINIUPNPC_DIR)
	$(CD) $(TARGET_MIPS)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_MIPS_ENV) INSTALLPREFIX=$(shell pwd)/$(TARGET_MIPS) $(MAKE) install

$(TARGET_MIPS64)/lib/libminiupnpc.a: $(TARGET_MIPS64)/src/$(MINIUPNPC_DIR)
	$(CD) $(TARGET_MIPS64)/src/$(MINIUPNPC_DIR) && $(TOOLCHAIN_MIPS64_ENV) INSTALLPREFIX=$(shell pwd)/$(TARGET_MIPS64) $(MAKE) install
